...
public final class PackageProcessor {
    ...
    public init(inputPath: String, outputPath: String) throws {
        ...
        self.packageDependencies = try PackageLoader.loadPackageDependencies(from: inputPath)
    }
    ...
    public func run() throws {
        ...
        fputs("  Writing Package.md", stdout)
        try MarkdownFile(filename: "Package", basePath: outputPath, content: content).write()
        fputs(" ✔\n".green, stdout)
        fputs("Done 🎉\n".green, stdout)
    }
